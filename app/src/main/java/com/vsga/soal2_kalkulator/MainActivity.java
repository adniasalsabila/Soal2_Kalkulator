package com.vsga.soal2_kalkulator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        angka_pertama = (EditText) findViewById(R.id.input1);
        angka_kedua = (EditText) findViewById(R.id.input2);
        tambah = (Button) findViewById(R.id.btnPlus);
        kurang = (Button) findViewById(R.id.btnMin);
        kali = (Button) findViewById(R.id.btnMultiple);
        bagi = (Button) findViewById(R.id.btnDivide);
        bersihkan = (Button) findViewById(R.id.btnClear);
        hasil = (TextView) findViewById(R.id.tv_result);
